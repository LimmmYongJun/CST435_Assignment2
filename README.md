...
A parallel image processing system that applies various filters to images using two different Python parallel programming paradigms: **multiprocessing** and **concurrent.futures**.
